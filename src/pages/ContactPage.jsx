...
const ContactPage = () => {
  ...
  const [submitStatus, setSubmitStatus] = useState(null); // For success/error feedback
  ...
  const handleSubmit = async (event) => {
    ...
    // --- Submission Logic ---
    // This section is where you'd integrate your actual form submission.
    ...
    try {
      ...
      setSubmitStatus("Network error: Could not send message. Please check your connection.");
    }
  ...
  const cardDetails = [
    ...
    },
    {
      ...
      link: {
        url: "https://maps.app.goo.gl/hQk1K5rY443aQ5rRA", // Updated with a more direct Google Maps link
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                required // Added 'required' for basic HTML5 validation
              />
            </div>
            <div>
            ...
            <div>
              <label htmlFor="message">
                Detailed message about selected purpose: {purpose || "N/A"}
              </label>
              <textarea
                id="message"
                rows={10}
            ...
            {submitStatus && <p className={`submit-status ${submitStatus.includes("successfully") ? "success" : "error"}`}>{submitStatus}</p>}
          </form>
          <motion.div
